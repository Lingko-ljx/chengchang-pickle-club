...
const allowedClientScript =
  /\b(?:data-booking-form-client|data-booking-result-client|data-booking-status-client|data-admin-client|data-homepage-media-client|data-honor-media-client|data-public-schedule-client|data-wechat-entry-client)(?:\s|=|$)/i;
